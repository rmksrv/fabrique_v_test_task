...
class Question(models.Model):
    """
    NOTE: для слоя данных нет никакой разницы между вопросом с выбором ответа и текстовым -- предполагается,
    что ответ на вопрос с выбором ответа будет конвертится в json на стороне формы, например, и хранится как и текст
    """
    class Meta:
        verbose_name = "Вопрос"
